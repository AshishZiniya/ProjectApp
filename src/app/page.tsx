...
import { faRocket, faUsers, faCheckCircle } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <div className="min-h-[calc(100vh-128px)] flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 text-gray-800 p-6">
      <div className="text-center mb-12">
        <div className="mb-6">
          <FontAwesomeIcon icon={faRocket} className="text-6xl text-blue-600 mb-4" />
        </div>
        <h1 className="text-6xl font-extrabold text-center mb-6 leading-tight bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
          Welcome to Your{' '}
          <span className="block">Project Management</span> Hub
        </h1>
        <p className="text-xl text-center max-w-3xl mb-10 text-gray-600 leading-relaxed">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 max-w-6xl">
        ...
        <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
          ...
          <p className="text-gray-600">Work together efficiently with your team members.</p>
        </div>
        <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
          <FontAwesomeIcon icon={faRocket} className="text-4xl text-purple-500 mb-4" />
